...
there are no fully redundant instructions. In Figure-\ref{fig:dfsin}, if B3 B4
B5 and B6 have identical computations and for some reason they cannot be hoisted
together at B0, then we partition the set of hoistable candidates in their DFSin
order.
