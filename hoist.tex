...
We ran llvm-testsuite (trunk:d87471f8) with the patch (trunk:86940146 and the results are:
...
\begin{table}[h!]
  \begin{center}
    \begin{tabular}{|l|c|}
      \hline
      Metric                   	     & Number\\\hline
      Instructions hoisted & 21616 \\\hline
      Instructions removed & 30438 \\\hline
