...
current implementation: first, sorting by DFSIn numbers does not give the right
order when there are fully redundant instructions, second, it lacks cost model
for partitioning in order to preserve/improve performance.
