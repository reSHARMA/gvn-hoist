...
hoisting is not a redundancy elimination pass.  The goals of code hoisting are:
\begin{itemize}
...
\begin{verbatim}
BasicBlock B1, B2, B3 // B1 != B2 != B3
DFSIn(B1) = depth first discovery time stamp
DFSIn(B1,B2) = abs(DFSIn(B1) - DFSIn(B2))
DFSIn(B1,B3) = abs(DFSIn(B1) - DFSIn(B3))
BBDist(B1,B2) = BBDist(B1, nearest-common-dom(B1, B2))
BBDist(B1,B3) = BBDist(B1, nearest-common-dom(B1, B3))
...
redundant i.e., none of the basic blocks containing I1, I2 and I3 dominate the
other.

\begin{verbatim}
DFSIn(I1) = DFSIn of containing basic block
DFSIn(I1,I2) = abs(DFSIn(I1) - DFSIn(I2))
DFSIn(I1,I3) = abs(DFSIn(I1) - DFSIn(I3))
BBDist(I1,I2) = BBDist(I1, nearest-common-dom(I1, I2))
BBDist(I1,I3) = BBDist(I1, nearest-common-dom(I1, I3))
...
unless (greedy approach). We split the list at a point where the legality checks
fail to hoist subset of candidates which are legal to hoist and, start finding
