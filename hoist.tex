...
\begin{itemize}
\item find candidates to hoist and compute hoisting position,
\item check whether moving the code is legal and profitable,
...
program and classifying all instructions by their value given by GVN.  The
current implementation of GVN in LLVM has some limitations when it comes to
...
want to hoist limited set of instructions from the sibling branches as we iterate
...
legal and profitable for the code-hoisting.
