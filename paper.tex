...
\begin{abstract}
We present a global code motion (GCM) compiler optimization which schedules
...
saving of 1\% on overall compile time on \SPEC{}. GCM enables more inlining and
exposes more loop invariant code motion opportunities in majority of the
...
\SPEC{} bencmarks suite when compiled for X86\_64. This is an optimistic
algorithm in the sense that it considers all identical computations in a
...
formalize how register pressure will reduce as a result of code-motion, and how
code-motion increases instruction level parallelism thereby enabling more out of
order execution on modern architectures.
\end{abstract}
...
\begin{table}[h!]
 ...
 483.xalancbmk	  & 9997	& 11453	& 56	& 54	& 69534	& 68839	& 29875	& 29519\\\hline
    \end{tabular}
  \end{center}
  \caption{Static metrics before and after code-hoisting on SPEC2006 at -Ofast. GCM improves LICM and inlining}
  \label{tab:stats}
\end{table}
