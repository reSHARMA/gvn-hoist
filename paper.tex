...
case a common hoisting point for all the candidates cannot be found. We also
...
\begin{verbatim}
// Compute downward safety of hoistable instructions at hoist-point
void compute_downward_safety()
...
int doCodeHoisting()
  ...
  // Do the code hoisting and update statistics
