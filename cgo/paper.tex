...
enables other passes like loop invariant motion to remove redundancies. The cost
model to drive the code motion is based on liveness analysis on \SSA{}
representation such that the (virtual) register pressure does not increase
resulting in 2\% fewer spills on the \SPEC{} benchmark suite. \GCM{} is an
...
performance gains of 8\% in 462.libquantum and 5.3\% in 471.omnetpp in \SPEC{}
benchmark suite. It also reduces compilation time by reducing number of
